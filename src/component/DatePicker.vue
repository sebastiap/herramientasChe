  ...
  <div class="datepicker">
    ...
    <div class="input-group">
      <input class="form-control datepicker-input" type="text"
        ...
        @click="inputClick"
      />
      <div class="input-group-append" @click="inputClick">
      ...
      <div class="datepicker-inner">
        <div class="datepicker-body">
          ...
          <div class="datepicker-weekRange">
            <span v-for="(w, i) in text.daysOfWeek" :key="i">{{w}}</span>
          </div>
          <div class="datepicker-dateRange">
            <span v-for="(d, i) in dateRange" :key="i" :class="d.sclass" @click="daySelect(d)">{{d.text}}</span>
          </div>
        </div>
      </div>
      <div class="text-center mb-2" v-if="hoy">
        <b-button size="sm" variant="light" @click="todaySelect">Hoy</b-button>
      </div>
    </div>
        ...
        <div class="datepicker-body">
          ...
          <div class="datepicker-monthRange">
            <template v-for="(m, index) in text.months">
              <span v-text="m.substr(0,3)" :key="index"
        ...
        <div class="datepicker-body">
          ...
          <div class="datepicker-monthRange decadeRange">
            <template v-for="(decade, i) in decadeRange">
              <span :key="i" :class="{'datepicker-dateRange-item-active':parse(val).getFullYear() === decade.text}"
                v-text="decade.text"
...
export default {
  props: {
    ...
    placeholder: { type: String, default: 'Seleccioná una fecha' },
  ...
  data () {
    return {
      ...
      text: {
        ...
        limit: 'Límite alcanzado (máximo {{limit}} items).',
        loading: 'Cargando...',
...
.datepicker > button.close {
  position: absolute;
  top: 34px; /* Antes era 0, cuando no estaba el tag <label> */
  right: 0;
  outline: none;
  z-index: 2;
  display: block;
